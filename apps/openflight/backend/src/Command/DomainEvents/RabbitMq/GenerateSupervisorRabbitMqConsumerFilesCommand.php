...
namespace CodelyTv\Apps\OpenFlight\Backend\Command\DomainEvents\RabbitMq;
...
command      = {path}/apps/openflight/backend/bin/console codelytv:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
