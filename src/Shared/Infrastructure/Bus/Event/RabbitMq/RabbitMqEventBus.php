...
{
    public function __construct(private readonly RabbitMqConnection $connection, private readonly string $exchangeName, private readonly MySqlDoctrineEventBus $failoverPublisher)
    {
    }
